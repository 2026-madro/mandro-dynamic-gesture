...
[`docs/LOCAL_MIGRATION.md`](app/src/main/java/com/mandro/docs/LOCAL_MIGRATION.md).
...
- 문서: `app/src/main/java/com/mandro/docs/RAW_STREAM_TOGGLE.md`(설계 논의+결정
  사항 전체 기록)
...
| [`docs/LOCAL_MIGRATION.md`](app/src/main/java/com/mandro/docs/LOCAL_MIGRATION.md) | 서버 제거, 로컬 전환 배경/설계 (진화 3단계 상세) |
...
| [`docs/CHAQUOPY_TODO.md`](app/src/main/java/com/mandro/docs/CHAQUOPY_TODO.md) | Chaquopy 마이그레이션 작업 목록 |
...
| [`docs/RAW_STREAM_TOGGLE.md`](app/src/main/java/com/mandro/docs/RAW_STREAM_TOGGLE.md) | raw EMG 스트리밍 On/Off(전력 절약) 설계 논의 — 진행 중 |
| [`docs/TERMINOLOGY.md`](app/src/main/java/com/mandro/docs/TERMINOLOGY.md) | UI 카피/용어 가이드 — 백엔드 구조와 무관해서 지금도 유효 |
| [`docs/BLEHARNESS.md`](app/src/main/java/com/mandro/docs/BLEHARNESS.md) | BLE 스캔/연결/권한 관련 코딩 가이드 — 지금도 유효 |

**구버전 문서 (히스토리 보존, `docs/archive/`로 이동함 — 2026-07-20)**

| 문서 | 왜 archive됐는지 |
|---|---|
| [`docs/archive/README_v1_stale.md`](app/src/main/java/com/mandro/docs/archive/README_v1_stale.md) | 원래 루트 `README.md`. TFLite/Retrofit/서버 학습 등 로컬 전환 이전 아키텍처 설명 |
| [`docs/archive/FEATURES.md`](app/src/main/java/com/mandro/docs/archive/FEATURES.md) | Android v1(2026-06-30) 기능 명세서. 아키텍처/기술스택 부분 stale, 화면 흐름/랩 수집 설계는 지금도 유효(§2-1 참고) |
| [`docs/archive/HARNESS.md`](app/src/main/java/com/mandro/docs/archive/HARNESS.md) | "DO NOT TOUCH: EmgFeatureExtractor.kt" 섹션만 stale(그 파일 자체가 죽은 코드가 됨), 나머지 Compose/MVVM 규칙은 유효 |
| [`docs/archive/BLEPROTOCOL.md`](app/src/main/java/com/mandro/docs/archive/BLEPROTOCOL.md) | 틀린 내용은 아니지만 `FIRMWARE_PROTOCOL.md`에 더 최신/상세하게 흡수됨(중복) |
